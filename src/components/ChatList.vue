    ...
    <div class="px-2 divide-y divide-gray-300 dark:divide-gray-700">
      <div v-for="message of messages">
        <div  class="flex items-center space-x-4 rounded-lg m-2"
          ...
          <div class="h-full text-center w-[160px] border-r border-gray-300 dark:border-gray-700 p-4 overflow-hidden pl-6" :class="{ [`dark:border-gray-800`]: message.username === username }">
          ...
          <div class="w-full flex flex-row items-center justify-between float-left p-4">
            <p class="text-md text-gray-800 dark:text-gray-200 p-4">{{ message.message }}</p>
