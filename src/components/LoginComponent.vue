      ...
      <div class="space-y-2">
        ...
        <div class="flex flex-row items-center justify-center">
          <input
              ...
              maxlength="15"
          />
          <button @click="handleChange" class="ml-2 p-2 flex rounded-lg border hover:border-gray-300 focus:border-gray-600"><span class="material-symbols-outlined">arrow_forward</span>
          </button>
        </div>
      </div>
