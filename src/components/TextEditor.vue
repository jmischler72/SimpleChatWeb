...
import {getDatabase, set, ref, push, query, limitToLast, serverTimestamp} from "firebase/database";
...
<template>
  ...
  -->
  <div class="w-[600px] max-w-[800px] bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
...
<!--      </button>-->
    ...
    <textarea
        class="w-full h-full p-4 text-gray-600 dark:text-gray-200 dark:bg-gray-700 text-md resize-none outline-none"
